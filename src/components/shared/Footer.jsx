...
// Nota: Si tu logo es .svg o .jpg, cambiale la extensión al final de esta línea
import Logo404 from '../../assets/404Logo.png'; 
    ...
    return (
        <footer className="bg-neutral-950 pt-16 pb-8 border-t border-neutral-900 text-neutral-400">
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                    ...
                    <Reveal animation="fade-in-up" delay="300ms" className="flex flex-col items-start md:items-end text-left md:text-right">
                        ...
                        <ul className="flex flex-col gap-3 text-sm mb-6 w-full md:items-end">
                            ...
                            <li className="flex items-center md:flex-row-reverse gap-3">
                                ...
                                <a 
                                    href="https://wa.me/5493815317139" 
                                    target="_blank" 
                        ...
                        <div className="flex items-center gap-4">
                            <a
                                href="https://www.instagram.com/radiolibertad.sanpedro/"
                                target="_blank"
                                rel="noopener noreferrer"
                            ...
                            <a
                                href="https://www.facebook.com/radiolibertad103.1"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="bg-neutral-900 p-2 rounded-full hover:bg-red-600 hover:text-white transition-all duration-300"
                                aria-label="Facebook"
                ...
                {/* Barra inferior: Copyright y Créditos de la Agencia */}
                <Reveal animation="fade-in-up" delay="400ms" className="border-t border-neutral-900 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-medium text-neutral-400">
                    ...
                    <div className="flex items-center gap-2 group cursor-pointer">
                        ...
                        <img 
                            src={Logo404} 
                            alt="404 Studio Logo" 
                            className="h-5 md:h-6 opacity-60 group-hover:opacity-100 transition-all duration-300 grayscale group-hover:grayscale-0" 
                        />
                        {/* Si tu archivo Logo404 ya tiene escrito el nombre "404 Studio", podés borrar la línea de abajo para que no se repita */}
                        <span className="text-white font-bold tracking-wider group-hover:text-red-500 transition-colors">
                            404 Studio
                        </span>
                    </div>
                </Reveal>
