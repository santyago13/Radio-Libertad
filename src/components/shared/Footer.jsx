            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 mb-12">
                    ...
                    <div className="flex flex-col items-start">
                        ...
                        <a href="#" className="flex items-center gap-2 group cursor-pointer mb-4">
                        ...
                        <p className="text-sm leading-relaxed max-w-xs">
                            Transmitiendo desde el corazón de San Pedro de Colalao. Acompañando tus días con la mejor música y la información local y provincial que necesitás.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-start md:items-center">
                        <div>
                            <h4 className="text-white font-bold tracking-wide uppercase mb-4 text-sm">Enlaces Rápidos</h4>
                            <ul className="flex flex-col gap-3 text-sm font-medium">
                                ...
                                <li>
                                    <a href="#" className="hover:text-red-500 transition-colors flex items-center gap-2">
                                        <span className="text-red-600 text-xs">▸</span> Quienes Somos
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="flex flex-col items-start md:items-end text-left md:text-right">
                        <h4 className="text-white font-bold tracking-wide uppercase mb-4 text-sm">Comunicate</h4>
                        ...
                        <ul className="flex flex-col gap-3 text-sm mb-6 w-full md:items-end">
                            ...
                            <li className="flex items-center md:flex-row-reverse gap-3">
                                ...
                                <span>+54 9 381 XXXXXXX</span> {/* Acá va el número de la radio */}
                            </li>
                        </ul>

                        {/* Íconos de Redes */}
                        <div className="flex items-center gap-4">
                            <a href="#" className="bg-neutral-900 p-2 rounded-full hover:bg-red-600 hover:text-white transition-all duration-300" aria-label="Instagram">
                            ...
                            <a href="#" className="bg-neutral-900 p-2 rounded-full hover:bg-red-600 hover:text-white transition-all duration-300" aria-label="Facebook">
