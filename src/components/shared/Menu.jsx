...
const Menu = () => {
    ...
    const getLinkClass = (path) => 
        `relative py-2 transition-colors after:absolute after:bottom-0 after:left-0 after:h-0.5 after:transition-all 
    ...
    return (
        <nav className="fixed top-0 w-full z-50 bg-black/90 backdrop-blur-md border-b border-neutral-800 text-neutral-content transition-all flex flex-col shadow-xl">
            ...
            <div className="max-w-7xl mx-auto w-full grid grid-cols-2 lg:grid-cols-3 items-center px-4 md:px-8 h-16 md:h-20">
                ...
                <Reveal animation="fade-in-left" className="flex-1 flex justify-start">
                    <Link to="/" onClick={closeMobileMenu} className="flex items-center gap-2 group cursor-pointer">
                        ...
                        <span className="text-neutral-400 font-light text-xs md:text-sm tracking-widest border-l border-neutral-700 pl-2">103.1</span>
                    </Link>
                </Reveal>

                <Reveal animation="fade-in-down" className="hidden lg:flex items-center gap-8 font-semibold tracking-wide text-sm justify-center">
                ...
                <Reveal animation="fade-in-right" className="flex-1 flex items-center justify-end gap-2 md:gap-6">
                    ...
                    <button onClick={toggleMenu} className="btn btn-ghost btn-circle text-neutral-300 hover:text-white lg:hidden">
